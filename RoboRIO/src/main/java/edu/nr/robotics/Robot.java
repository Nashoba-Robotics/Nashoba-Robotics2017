...
import edu.nr.robotics.auton.DriveToBlueLeftSideGearNoShootAutoCommand;
import edu.nr.robotics.auton.DriveToBlueLeftSideGearShootFirstAutoCommand;
import edu.nr.robotics.auton.DriveToBlueLeftSideGearShootRegularAutoCommand;
...
public class Robot extends IterativeRobot {
	...
	public void autoChooserInit() {
		...
		autoSpotChooser.addObject("Blue Left Gear Shoot Later", new DriveToBlueLeftSideGearShootRegularAutoCommand());
